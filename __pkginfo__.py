...
web = github_url = f"https://github.com/domdfcoding/ytools3"
project_urls = {
		"Documentation": f"https://ytools3.readthedocs.io",
...
long_description = (repo_root / "README.rst").read_text(encoding="utf-8").replace("3.0.0", __version__) + '\n'
